...
class VendorForm(FlaskForm):
    ...
    image = FileField('Vendor Image', validators=[Optional()])
...
class UserForm(FlaskForm):
    ...
    can_view_sales = BooleanField('Sales Access', default=False)
    can_view_purchases = BooleanField('Purchases Access', default=False)
    can_view_inventory = BooleanField('Inventory Access', default=False)
    can_view_expenses = BooleanField('Expenses Access', default=False)
    can_view_returns = BooleanField('Returns Access', default=False)
    can_view_vendors = BooleanField('Vendors Access', default=False)
    can_view_customers = BooleanField('Customers Access', default=False)
    can_view_reports = BooleanField('Reports Access', default=False)
    can_view_settings = BooleanField('Settings Access', default=False)
    can_view_manufacturing = BooleanField('Manufacturing Access', default=False)
    can_view_production = BooleanField('Production Access', default=False)
    can_view_warehouse = BooleanField('Warehouse Access', default=False)
    can_view_attendance = BooleanField('Attendance Access', default=False)
    can_view_salary = BooleanField('Salary Access', default=False)
    can_view_targets = BooleanField('Targets Access', default=False)
    can_view_dashboard = BooleanField('Dashboard Access', default=False)
    can_view_accounting = BooleanField('Accounting Access', default=False)
    can_view_salesmen = BooleanField('Salesmen Access', default=False)
    can_view_product_dev = BooleanField('Product Development Access', default=False)
    can_view_categories = BooleanField('Product Categories Access', default=False)
    can_view_customer_groups = BooleanField('Customer Groups Access', default=False)
