# Purchase Order PDF Template Configuration
# This file defines the structure for purchase order PDFs
# Edit this file to customize the PO layout
...
TOTALS = [
    ...
    ('total', 'Total:', True),
    ('advance_amount', 'Advance Paid:', True),
...
# Additional notes to include from PO
